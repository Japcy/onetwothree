...
export default {
  ...
  data () {
    ...
    var checkMobile = (rule, value, cb) => {
      let reg = /^(0|86|17951)?(13[0-9]|15[012356789]|17[678]|18[0-9]|14[57])[0-9]{8}$/ if (reg.test(value)) { cb() } else { cb(new Error('手机号码格式不正确')) }
    }
    // 验证邮箱的规则
    ...
    return {
      ...
      addFormRules: {
        ...
        mobile: [
          ...
          { min: 11, max: 11, message: '长度为11位手机号码', trigger: 'blur' }
        ],
        email: [
