    ...
    <el-container class="home-container">
      ...
      <el-container>
        ...
        <el-aside :width="isCollapse ? '64px' : '200px'">
          <span class="toggle" @click="toggleCollapse" :value="isCollapse ? '+' : '-'"></span>
          <!-- 侧边栏菜单 -->
          <el-menu :collapse="isCollapse" :collapse-transition="false" background-color="#333744" text-color="#fff" active-text-color="#409eff" unique-opened>
            <!-- 一级菜单 -->
